...
func Start() {
	...
	svc := eds.NewEndpoint(services, agent.NewAgent(cfg.ConsulAddress(), cfg.ConsulToken(), cfg.ConsulDC()), cfg.GetHTTPHeaderRateLimitConfig(), cfg.EnableHealthCheckCatalogService())
